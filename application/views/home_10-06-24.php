...
<html lang="en" class="fontawesome-i2svg-active fontawesome-i2svg-complete">
   ...
   <body class="home-page">
      ...
      <div class="content container">
                ...
                <div class="col-md-9 col-12">
                    <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                           ...
                           $query = "SELECT * FROM `news` where status=1 and category=1  ORDER BY 'date',`id`  desc limit 2";
                           ...
                           <?php } ?>
                            ...
                            <?php                         
                           $query = "SELECT * FROM `news` where status=1 and category=3 and image!='' ORDER BY 'date',`id`  desc limit 3";
                           $nationalNews = $this->master_model->customQueryArray($query); 
                           $Sr = 1;
                           foreach($nationalNews as $newsData){
                                    $newsId = $newsData['id'];
                ...
                <div>
                        ...
                        <div>
                            <h5><span class="cline"> 
							 <?php 
							$categoryId = 3;
							echo $getCategeriesHindiName[$categoryId]?> Live </span>
                            </h5>
                        </div>
                        <?php /*?> <marquee behavior="" Scrollamount=2 direction="up" style="height: 300px;overflow: hidden;font-size: 15px;"> 
			<?php 
            ...
            $rssNewsItemes = $newsItemes['channel']['item'];
            foreach($rssNewsItemes as $newsData) {
                    ...
                    <div class="section_background" style="height: 360px;overflow: hidden;padding: 10px;">
                        <div>
                         ...
                         <marquee behavior="" Scrollamount=2 direction="up" style="height: 300px;overflow: hidden;font-size: 15px;"> 
                            <?php 
                            $query = "SELECT * FROM `news` where status=1 and category=$categoryId ORDER BY 'date',`id`  desc limit 6";
                            $nationalNews = $this->master_model->customQueryArray($query);                          
                              foreach($nationalNews as $newsData) {
                                 $newsId = $newsData['id'];
                                 $heading = strip_tags($newsData['heading']);
                  ...
                  <div class="row">
                     <div class="col-md-6 col-12">
                        <div class="section_background">
                           ...
                           <?php    
                           $query = "SELECT * FROM `news` where status=1 and category=$categoryId ORDER BY 'date',`id`  desc limit 2";
                           $nationalNews = $this->master_model->customQueryArray($query);                          
                           foreach($nationalNews as $newsData) {
                              $newsId = $newsData['id'];
                              $heading = strip_tags($newsData['heading']);
                     ...
                     <p>
                        ...
                        <p>
                           <a href="https://mpinfo.org/RSSFeed/RSSFeed_News.xml" target="_new">
                              ...
                              <!-- <i class="fas fa-caret-right"></i> -->मध्य प्रदेश जनसम्पर्क विभाग RSS Feed 
                           </a>
                        </p>
                   ...
                   <div id="news-carousel" class="news-carousel carousel slide">
                      <div class="carousel-inner">
                         <div class="item carousel-item active">
                            ...
                            <?php    
                           $query = "SELECT * FROM `news` where status=1 and category=$categoryId ORDER BY 'date',`id`  desc limit 0,3";
                           $nationalNews = $this->master_model->customQueryArray($query);                          
                           foreach($nationalNews as $newsData) {
                              $newsId = $newsData['id'];
                              $heading = strip_tags($newsData['heading']);
                         ...
                         <div class="item carousel-item">
                            ...
                            <?php    
                           $query = "SELECT * FROM `news` where status=1 and category=$categoryId ORDER BY 'date',`id`  desc limit 3,6";
                           $nationalNews = $this->master_model->customQueryArray($query);                          
                           foreach($nationalNews as $newsData) {
                              $newsId = $newsData['id'];
                              $heading = strip_tags($newsData['heading']);
